...
public class DeviceFragment2 extends Fragment
{
     ...
     * @return
     */
    public static DeviceFragment2 newInstance(MainActivity activity, String param2)
    {
    ...
    public void InitView()
    {
        ...
        materialRefreshLayout.setMaterialRefreshListener(new MaterialRefreshListener()
        {
            ...
            {
                Toast.makeText(m_context, "finish", Toast.LENGTH_LONG).show();
            }

            @Override
            public void onRefreshLoadMore(MaterialRefreshLayout materialRefreshLayout)
            {
                Toast.makeText(m_context, "load more", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    {
        m_deviceView = inflater.inflate(R.layout.fragment_device2, container, false);
