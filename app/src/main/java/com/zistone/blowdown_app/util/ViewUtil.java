...
public class ViewUtil
{
    ...
    public void showToast(Fragment fragment, String message)
    {
        StringBuilder strBuilder = new StringBuilder("<font face='" + fragment.getString(R.string.font_type) + "'>");
        strBuilder.append(message).append("</font>");

        View toastRoot = fragment.getLayoutInflater().inflate(R.layout.layout_toast, null);
        ...
        mToast.setGravity(Gravity.BOTTOM, 0, fragment.getResources().getDisplayMetrics().heightPixels / 5);
        mToast.show();
    }
