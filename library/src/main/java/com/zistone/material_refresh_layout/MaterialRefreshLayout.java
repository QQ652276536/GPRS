package com.zistone.material_refresh_layout;
...
public class MaterialRefreshLayout extends FrameLayout
{
    ...
    private void init(Context context, AttributeSet attrs, int defstyleAttr)
    {
        ...
        textType = t.getInt(R.styleable.MaterialRefreshLayout_progress_txt_visibility, 1);
        progressTextColor = t.getColor(R.styleable.MaterialRefreshLayout_progress_txt_color, Color.BLACK);
